<?php /* Template Name: Color Pettle Template */ 
get_header();
							...
							<div class="palette">
								...
								<ul class="palette_colors">
									<?php foreach( $color_pattel as $color ){ 
										...
										?>
										<li class="is-light <?php echo $dark_color_class; ?>" style="background: <?php echo $color_name; ?>"><a href="<?php echo $href; ?>" <?php echo $target_blank; ?>><span class="color-name"><?php echo $color_pms; ?></span></a></li>
									<?php } ?>
								</ul>
		...
		if(!empty($terms)){ ?>
			<div class="megasearch_menu_color">
				<?php foreach ($terms as $term){ ?>
					<a class="tag" id="<?php echo $term->slug; ?>" href="<?php echo get_term_link( $term->slug, 'color-category' ); ?>"><i class="fa fa-circle" style="color:<?php echo $term->slug; ?>;"></i><?php echo $term->name; ?></a>
				<?php } ?>
			</div>
		<?php } ?>
	</div>
