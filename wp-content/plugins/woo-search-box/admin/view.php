...
<div id="icon-options-general" class="icon32"><br></div><h2 id="gws_admin"><?php _e('WooCommerce Search Engine','guaven_woo_search');?>
...
<a class="tablinks" id="guaven_woos_tablink_analytics"  target="_blank" href="?page=woo-search-box%2Fadmin%2Fclass-search-analytics.php">
  <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
    <path d="M14 3h7v7"/>
    <path d="M10 14 21 3"/>
    <path d="M21 14v7H3V3h7"/>
  </svg>
  <span><?php _e('Search Analytics','guaven_woo_search');?></span>
</a>
