...
<div class="options_group pricing <?php echo esc_attr_e( $simple_show_class ); ?> as-box as-box-<?php echo esc_attr( $value_id ); ?>" >
	<label
	class="as-label"><?php echo esc_attr_e( 'Label P/C', 'woo-products-quantity-range-pricing' ); ?></label>
	<input type="text" value="<?php echo trim( $woo_qrp_label ); ?>"
	name="woo-qrp-label-<?php echo esc_attr( $value_id ); ?>" data-id="<?php echo esc_attr( $value_id ); ?>">
</div>
<div class="options_group pricing  <?php echo esc_attr_e( $simple_show_class ); ?> as-box as-box-<?php echo esc_attr( $value_id ); ?>">
	...
	<table id="as-table-<?php echo esc_attr( $value_id ); ?>" class="as-table">
		<thead>
			<tr>
				<td>
					<label class="as-label"><?php echo esc_attr_e( 'Display Blank Pricing', 'woo-products-quantity-range-pricing' ); ?></label>
				</td>
				<td>
					<label class="as-label"><?php echo esc_attr_e( 'Min Quantity', 'woo-products-quantity-range-pricing' ); ?></label>
				</td>
				<td>
					<label class="as-label"><?php echo esc_attr_e( 'Max Quantity', 'woo-products-quantity-range-pricing' ); ?></label>
				</td>
				<td>
					<label class="as-label"><?php echo esc_attr_e( 'Price type', 'woo-products-quantity-range-pricing' ); ?></label>
				</td>
				<td>
					<label class="as-label"><?php echo esc_attr_e( 'Regular Price', 'woo-products-quantity-range-pricing' ); ?></label>
				</td>
				<td>
					<label class="as-label"><?php echo esc_attr_e( 'Sales Price', 'woo-products-quantity-range-pricing' ); ?></label>
				</td>
				<td>
					<label class="as-label"><?php echo esc_attr_e( 'Special Price', 'woo-products-quantity-range-pricing' ); ?></label>
				</td>
				<td>
					<label class="as-label"><?php echo esc_attr_e( 'Price', 'woo-products-quantity-range-pricing' ); ?></label>
				</td>
				<td>
					<label class="as-label"><?php echo esc_attr_e( 'CND Price', 'woo-products-quantity-range-pricing' ); ?></label>
				</td>
				<td>
					<label class="as-label"><?php echo esc_attr_e( '2nd Price', 'woo-products-quantity-range-pricing' ); ?></label>
				</td>
				<td>
					<label class="as-label"><?php echo esc_attr_e( '2nd CND Price', 'woo-products-quantity-range-pricing' ); ?></label>
				</td>
				<td>
