...
<?php
        ...
        ?> <iframe src=" <?php echo \esc_url($embed_url); ?>" height="480" style="width:100%;aspect-ratio:<?php echo \esc_attr($embed_ratio); ?>;height:auto;max-height:100vh;border:none;overflow: hidden;" class="uyd-embedded" allowfullscreen loading="lazy" referrerpolicy="no-referrer" title="<?php echo $item['basename']; ?>"></iframe><?php
