...
class Update
{
    public static function init()
    {
        ...
        PucFactory::buildUpdateChecker('https://www.wpcloudplugins.com/updates_v2/?action=get_metadata&slug=use-your-drive&purchase_code='.License::get().'&plugin_id='.Core::$plugin_id.'&siteurl='.License::get_home_url().'&beta='.$beta_updates, plugin_dir_path(__DIR__).'/use-your-drive.php');
    }
