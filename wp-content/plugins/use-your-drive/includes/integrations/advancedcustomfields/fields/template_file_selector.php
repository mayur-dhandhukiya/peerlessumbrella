...
<div id="wpcp" class="wpcp-app">
    ...
    <!-- Modal Selector -->
    <div id="wpcp-modal-acf-selector-google" class="wpcp-dialog hidden">
...
$params = apply_filters('useyourdrive_set_shortcode_file_selector', $params, 'advancedcustomfields');
