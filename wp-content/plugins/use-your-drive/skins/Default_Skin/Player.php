...
class Default_Skin extends MediaplayerSkin
{
    ...
    public function load_scripts($dependency = [])
    {
        ...
        wp_register_script('UseyourDrive.Default_Skin.Player', $this->get_url().'/js/Player.js', ['WPCloudPlugins.Polyfill', 'Default_Skin.Library', 'WPCloudplugin.Libraries'], USEYOURDRIVE_VERSION, true);
