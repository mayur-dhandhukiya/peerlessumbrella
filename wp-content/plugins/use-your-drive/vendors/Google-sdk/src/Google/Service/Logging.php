 ...
 * @author Google, Inc.
 */
class UYDGoogle_Service_Logging extends UYDGoogle_Service
{
  ...
  public function __construct(UYDGoogle_Client $client)
  {
    ...
    $this->entries = new UYDGoogle_Service_Logging_Entries_Resource(
        $this,
        $this->serviceName,
        'entries',
        array(
    ...
    $this->monitoredResourceDescriptors = new UYDGoogle_Service_Logging_MonitoredResourceDescriptors_Resource(
        $this,
        $this->serviceName,
    ...
    $this->projects_logs = new UYDGoogle_Service_Logging_ProjectsLogs_Resource(
        $this,
        $this->serviceName,
        'logs',
        array(
    ...
    $this->projects_metrics = new UYDGoogle_Service_Logging_ProjectsMetrics_Resource(
        $this,
        $this->serviceName,
        'metrics',
        array(
    ...
    $this->projects_sinks = new UYDGoogle_Service_Logging_ProjectsSinks_Resource(
        $this,
        $this->serviceName,
        'sinks',
        array(
 ...
 * Typical usage is:
 *  <code>
 *   $loggingService = new UYDGoogle_Service_Logging(...);
 *   $entries = $loggingService->entries;
 *  </code>
 */
class UYDGoogle_Service_Logging_Entries_Resource extends UYDGoogle_Service_Resource
{
   ...
   *
   * @param UYDGoogle_ListLogEntriesRequest $postBody
   * @param array $optParams Optional parameters.
   * @return UYDGoogle_Service_Logging_ListLogEntriesResponse
   */
  public function listEntries(UYDGoogle_Service_Logging_ListLogEntriesRequest $postBody, $optParams = array())
  {
    $params = array('postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "UYDGoogle_Service_Logging_ListLogEntriesResponse");
  }
   ...
   *
   * @param UYDGoogle_WriteLogEntriesRequest $postBody
   * @param array $optParams Optional parameters.
   * @return UYDGoogle_Service_Logging_WriteLogEntriesResponse
   */
  public function write(UYDGoogle_Service_Logging_WriteLogEntriesRequest $postBody, $optParams = array())
  {
    $params = array('postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('write', array($params), "UYDGoogle_Service_Logging_WriteLogEntriesResponse");
  }
}
 ...
 *  </code>
 */
class UYDGoogle_Service_Logging_MonitoredResourceDescriptors_Resource extends UYDGoogle_Service_Resource
{
   ...
   * @return UYDGoogle_Service_Logging_ListMonitoredResourceDescriptorsResponse
   */
  public function listMonitoredResourceDescriptors($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "UYDGoogle_Service_Logging_ListMonitoredResourceDescriptorsResponse");
  }
}
 ...
 *  </code>
 */
class UYDGoogle_Service_Logging_Projects_Resource extends UYDGoogle_Service_Resource
{
}
 ...
 *  </code>
 */
class UYDGoogle_Service_Logging_ProjectsLogs_Resource extends UYDGoogle_Service_Resource
{
   ...
   * @param array $optParams Optional parameters.
   * @return UYDGoogle_Service_Logging_Empty
   */
  public function delete($logName, $optParams = array())
  {
    $params = array('logName' => $logName);
    $params = array_merge($params, $optParams);
    return $this->call('delete', array($params), "UYDGoogle_Service_Logging_Empty");
  }
}
/**
 ...
 *  </code>
 */
class UYDGoogle_Service_Logging_ProjectsMetrics_Resource extends UYDGoogle_Service_Resource
{
   ...
   * @param UYDGoogle_LogMetric $postBody
   * @param array $optParams Optional parameters.
   * @return UYDGoogle_Service_Logging_LogMetric
   */
  public function create($projectName, UYDGoogle_Service_Logging_LogMetric $postBody, $optParams = array())
  {
    $params = array('projectName' => $projectName, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('create', array($params), "UYDGoogle_Service_Logging_LogMetric");
  }
  ...
  public function get($metricName, $optParams = array())
  {
    $params = array('metricName' => $metricName);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "UYDGoogle_Service_Logging_LogMetric");
  }
   ...
   * which you can retrieve by passing the `nextPageToken` value in the
   * `pageToken` parameter to the next request.
   * @return UYDGoogle_Service_Logging_ListLogMetricsResponse
   */
  public function listProjectsMetrics($projectName, $optParams = array())
  {
    $params = array('projectName' => $projectName);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "UYDGoogle_Service_Logging_ListLogMetricsResponse");
  }
   ...
   * @return UYDGoogle_Service_Logging_LogMetric
   */
  public function update($metricName, UYDGoogle_Service_Logging_LogMetric $postBody, $optParams = array())
  {
    $params = array('metricName' => $metricName, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "UYDGoogle_Service_Logging_LogMetric");
  }
}
/**
 ...
 *  </code>
 */
class UYDGoogle_Service_Logging_ProjectsSinks_Resource extends UYDGoogle_Service_Resource
{
   ...
   * @param UYDGoogle_LogSink $postBody
   * @param array $optParams Optional parameters.
   * @return UYDGoogle_Service_Logging_LogSink
   */
  public function create($projectName, UYDGoogle_Service_Logging_LogSink $postBody, $optParams = array())
  {
    $params = array('projectName' => $projectName, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('create', array($params), "UYDGoogle_Service_Logging_LogSink");
  }
  ...
  public function get($sinkName, $optParams = array())
  {
    $params = array('sinkName' => $sinkName);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "UYDGoogle_Service_Logging_LogSink");
  }
   ...
   * which you can retrieve by passing the `nextPageToken` value in the
   * `pageToken` parameter to the next request.
   * @return UYDGoogle_Service_Logging_ListSinksResponse
   */
  public function listProjectsSinks($projectName, $optParams = array())
  {
    $params = array('projectName' => $projectName);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "UYDGoogle_Service_Logging_ListSinksResponse");
  }
   ...
   * @return UYDGoogle_Service_Logging_LogSink
   */
  public function update($sinkName, UYDGoogle_Service_Logging_LogSink $postBody, $optParams = array())
  {
    $params = array('sinkName' => $sinkName, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "UYDGoogle_Service_Logging_LogSink");
  }
}
...
class UYDGoogle_Service_Logging_Empty extends UYDGoogle_Model
{
}

class UYDGoogle_Service_Logging_HttpRequest extends UYDGoogle_Model
{
...
class UYDGoogle_Service_Logging_LabelDescriptor extends UYDGoogle_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $description;
...
class UYDGoogle_Service_Logging_ListLogEntriesRequest extends UYDGoogle_Collection
{
...
class UYDGoogle_Service_Logging_ListLogEntriesResponse extends UYDGoogle_Collection
{
  protected $collection_key = 'entries';
  protected $internal_gapi_mappings = array(
  );
  protected $entriesType = 'UYDGoogle_Service_Logging_LogEntry';
...
class UYDGoogle_Service_Logging_ListLogMetricsResponse extends UYDGoogle_Collection
{
  protected $collection_key = 'metrics';
  protected $internal_gapi_mappings = array(
  );
  protected $metricsType = 'UYDGoogle_Service_Logging_LogMetric';
...
class UYDGoogle_Service_Logging_ListMonitoredResourceDescriptorsResponse extends UYDGoogle_Collection
{
  protected $collection_key = 'resourceDescriptors';
  protected $internal_gapi_mappings = array(
  );
  public $nextPageToken;
  protected $resourceDescriptorsType = 'UYDGoogle_Service_Logging_MonitoredResourceDescriptor';
...
class UYDGoogle_Service_Logging_ListSinksResponse extends UYDGoogle_Collection
{
  protected $collection_key = 'sinks';
  protected $internal_gapi_mappings = array(
  );
  public $nextPageToken;
  protected $sinksType = 'UYDGoogle_Service_Logging_LogSink';
...
class UYDGoogle_Service_Logging_LogEntry extends UYDGoogle_Model
{
  protected $internal_gapi_mappings = array(
  );
  protected $httpRequestType = 'UYDGoogle_Service_Logging_HttpRequest';
  protected $httpRequestDataType = '';
  public $insertId;
  public $jsonPayload;
  public $labels;
  public $logName;
  protected $operationType = 'UYDGoogle_Service_Logging_LogEntryOperation';
  protected $operationDataType = '';
  public $protoPayload;
  protected $resourceType = 'UYDGoogle_Service_Logging_MonitoredResource';
  ...
  public function setHttpRequest(UYDGoogle_Service_Logging_HttpRequest $httpRequest)
  {
  ...
  public function setOperation(UYDGoogle_Service_Logging_LogEntryOperation $operation)
  {
  ...
  public function setResource(UYDGoogle_Service_Logging_MonitoredResource $resource)
  {
...
class UYDGoogle_Service_Logging_LogEntryOperation extends UYDGoogle_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $first;
...
class UYDGoogle_Service_Logging_LogLine extends UYDGoogle_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $logMessage;
  public $severity;
  protected $sourceLocationType = 'UYDGoogle_Service_Logging_SourceLocation';
  ...
  public function setSourceLocation(UYDGoogle_Service_Logging_SourceLocation $sourceLocation)
  {
...
class UYDGoogle_Service_Logging_LogMetric extends UYDGoogle_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $description;
...
class UYDGoogle_Service_Logging_LogSink extends UYDGoogle_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $destination;
...
class UYDGoogle_Service_Logging_MonitoredResource extends UYDGoogle_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $labels;
...
class UYDGoogle_Service_Logging_MonitoredResourceDescriptor extends UYDGoogle_Collection
{
  ...
  public $description;
  public $displayName;
  protected $labelsType = 'UYDGoogle_Service_Logging_LabelDescriptor';
...
class UYDGoogle_Service_Logging_RequestLog extends UYDGoogle_Collection
{
  ...
  public $ip;
  public $latency;
  protected $lineType = 'UYDGoogle_Service_Logging_LogLine';
  ...
  public $resource;
  public $responseSize;
  protected $sourceReferenceType = 'UYDGoogle_Service_Logging_SourceReference';
...
class UYDGoogle_Service_Logging_SourceLocation extends UYDGoogle_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $file;
...
class UYDGoogle_Service_Logging_SourceReference extends UYDGoogle_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $repository;
...
class UYDGoogle_Service_Logging_WriteLogEntriesRequest extends UYDGoogle_Collection
{
  protected $collection_key = 'entries';
  protected $internal_gapi_mappings = array(
  );
...
class UYDGoogle_Service_Logging_WriteLogEntriesResponse extends UYDGoogle_Model
{
}
