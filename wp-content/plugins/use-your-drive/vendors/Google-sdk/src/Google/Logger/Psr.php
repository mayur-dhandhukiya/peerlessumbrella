 ...
 * with the `UYDGoogle_Logger_Psr::setLogger()` method.
 */
class UYDGoogle_Logger_Psr extends UYDGoogle_Logger_Abstract
{
  /**
   ...
   */
  public function __construct(UYDGoogle_Client $client, /*Psr\Log\LoggerInterface*/ $logger = null)
  {
