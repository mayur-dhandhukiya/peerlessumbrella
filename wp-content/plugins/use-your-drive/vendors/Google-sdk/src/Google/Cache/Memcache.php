 ...
 */
class UYDGoogle_Cache_Memcache extends UYDGoogle_Cache_Abstract
{
  ...
  public function __construct(UYDGoogle_Client $client)
  {
    if (!function_exists('memcache_connect') && !class_exists("Memcached")) {
      ...
      throw new UYDGoogle_Cache_Exception($error);
    }
   ...
   * @param string $key
   * @param string $value
   * @throws UYDGoogle_Cache_Exception
   */
  public function set($key, $value)
  {
    ...
    if ($rc == false) {
      ...
      throw new UYDGoogle_Cache_Exception("Couldn't store data in cache");
    }
