 ...
 */
class UYDGoogle_Cache_File extends UYDGoogle_Cache_Abstract
{
  ...
  /**
   * @var UYDGoogle_Client the current client
   */
  private $client;
  ...
  public function delete($key)
  {
    ...
    if (file_exists($file) && !unlink($file)) {
      ...
      throw new UYDGoogle_Cache_Exception("Cache file could not be deleted");
    }
  ...
  private function getCacheDir($file, $forWrite)
  {
    ...
    if ($forWrite && ! is_dir($storageDir)) {
      if (! mkdir($storageDir, 0700, true)) {
        ...
        throw new UYDGoogle_Cache_Exception("Could not create storage directory: $storageDir");
      }
    }
    return $storageDir;
  }
