 ...
 */
class UYDGoogle_Auth_AppIdentity extends UYDGoogle_Auth_Abstract
{
  const CACHE_PREFIX = "UYDGoogle_Auth_AppIdentity::";
  private $client;
  private $token = false;
  private $tokenScopes = false;

  public function __construct(UYDGoogle_Client $client, $config = null)
  {
    $this->client = $client;
  }
