...
class UYDGoogle_Http_Request
{
  ...
  {
    $headers = UYDGoogle_Utils::normalize($headers);
  ...
  {
    return empty($this->userAgent) ? UYDGoogle_Client::USER_AGENT_SUFFIX . UYDGoogle_Client::LIBVER : $this->userAgent;
  }
