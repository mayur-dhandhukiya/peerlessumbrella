...
<div class="wpcp-browser-container wpcp-browser-tree--init wpcp-no-tree wpcp-browser--init" style="width:<?php echo $shortcode['maxwidth']; ?>;max-width:<?php echo $shortcode['maxwidth']; ?>;<?php echo (!empty($shortcode['maxheight'])) ? 'max-height:'.$shortcode['maxheight'].';overflow: hidden;' : ''; ?>">
    ...
    <div class="wpcp-browser-container-content">
        ...
        if ('1' === $shortcode['show_header']) {
            ?>
        <div class="nav-header <?php echo ('1' === $shortcode['show_breadcrumb']) ? 'nav-header-has-breadcrumb' : ''; ?>"><?php if ('1' === $shortcode['show_breadcrumb']) { ?>
            <a class="nav-tree-toggle entry-info-button" tabindex="0" title="<?php esc_html_e('Display folder tree', 'wpcloudplugins'); ?>">
                <i class="eva eva-arrowhead-left-outline"></i>
            </a>
            ...
            <div class="tippy-content-holder gear-div" data-token="<?php echo Processor::instance()->get_listtoken(); ?>">
                <ul data-id="<?php echo Processor::instance()->get_listtoken(); ?>">
            ...
            if (User::can_create_document()) {
                $need_separator = true; ?>
                    <li class="has-menu">
                        ...
                        <ul>
                            <li><a class="newentry" data-mimetype='application/vnd.google-apps.document' title="<?php esc_html_e('Google Doc', 'wpcloudplugins'); ?>"><img src="<?php echo Helpers::get_default_thumbnail_icon('application/vnd.google-apps.document'); ?>" alt="" /><?php esc_html_e('Google Doc', 'wpcloudplugins'); ?></a></li>
                            <li><a class="newentry" data-mimetype='application/vnd.google-apps.spreadsheet' title="<?php esc_html_e('Google Sheet', 'wpcloudplugins'); ?>"><img src="<?php echo Helpers::get_default_thumbnail_icon('application/vnd.google-apps.spreadsheet'); ?>" alt="" /><?php esc_html_e('Google Sheet', 'wpcloudplugins'); ?></a></li>
                            <li><a class="newentry" data-mimetype='application/vnd.google-apps.presentation' title="<?php esc_html_e('Google Slide', 'wpcloudplugins'); ?>"><img src="<?php echo Helpers::get_default_thumbnail_icon('application/vnd.google-apps.presentation'); ?>" alt="" /><?php esc_html_e('Google Slide', 'wpcloudplugins'); ?></a></li>
                        </ul>
                    </li>
                    <?php
            }
            ...
            if (User::can_import()) {
                $need_separator = true; ?>
                    <li class='list-separator'></li>
                    <li><a class='selected-files-import' title='" <?php esc_html_e('Add to Media Library', 'wpcloudplugins'); ?>"'><i class='eva eva-log-in-outline eva-lg'></i><?php esc_html_e('Add to Media Library', 'wpcloudplugins'); ?></a></li>
                    <?php
            }
            ...
            if ('1' === $shortcode['allow_switch_view']) {
                ?>
...
?>
            ...
            <div class="ajax-filelist">
                <div class='files'>
                    <div class="folders-container"><?php Skeleton::get_browser_placeholders('folder', 3); ?></div>
                    <div class="files-container"><?php Skeleton::get_browser_placeholders('file', 5); ?></div>
                </div>
            </div>
